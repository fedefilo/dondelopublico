...
if (isset($_REQUEST['buscar'])) {
 ...
 //This sets the range to display in our query 
	...
	$query2 = "call consulta3('$busqueda', '$_REQUEST[buscarpor]', $offset, $page_rows)";
	...
	render("../templates/resultados2.php", ["title" => "Resultados - $titulo", "resultados"=>$resultados, "buscarpor" => $buscarpor, "busqueda" => $_REQUEST['busqueda'], "pagenum"=>$pagenum, "last"=> $last, "total"=>$rows, "offset"=>$offset, "ultimomuestra"=>$ultimomuestra, "titulo" => $titulo]);
